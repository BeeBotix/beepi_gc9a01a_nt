...
#define BEEPI_RED        ((uint16_t)0xF800)
#define BEEPI_GREEN      ((uint16_t)0x07E0)
#define BEEPI_BLUE       ((uint16_t)0x001F)
#define BEEPI_CYAN       ((uint16_t)0x07FF)
#define BEEPI_MAGENTA    ((uint16_t)0xF81F)
#define BEEPI_YELLOW     ((uint16_t)0xFFE0)
#define BEEPI_ORANGE     ((uint16_t)0xFD20)
#define BEEPI_DARKGREY   ((uint16_t)0x7BEF)
#define BEEPI_LIGHTGREY  ((uint16_t)0xC618)
#define BEEPI_NAVY       ((uint16_t)0x000F)
#define BEEPI_DARKGREEN  ((uint16_t)0x03E0)
#define BEEPI_MAROON     ((uint16_t)0x7800)
#define BEEPI_OLIVE      ((uint16_t)0x7BE0)
#define BEEPI_PURPLE     ((uint16_t)0x780F)
#define BEEPI_PINK       ((uint16_t)0xFC18)
